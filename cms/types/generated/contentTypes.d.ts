...
export interface ApiMenyuVPodvaleMenyuVPodvale extends Struct.SingleTypeSchema {
  collectionName: 'menyu_v_podvales';
  info: {
    displayName: '\u041C\u0435\u043D\u044E \u0432 \u043F\u043E\u0434\u0432\u0430\u043B\u0435';
    pluralName: 'menyu-v-podvales';
    singularName: 'menyu-v-podvale';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FooterMenuItems: Schema.Attribute.DynamicZone<
      [
        'menu.vypadayushhee-menyu',
        'menu.ssylka',
        'menu.punkt-menyu',
        'menu.logo',
        'menu.knopka',
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::menyu-v-podvale.menyu-v-podvale'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    links: Schema.Attribute.Component<'menu.ssylka', true>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::section.section'
...
export interface ApiTopMenuTopMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    MainMenuItems: Schema.Attribute.DynamicZone<
      ['menu.vypadayushhee-menyu', 'menu.ssylka', 'menu.knopka', 'menu.logo']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
