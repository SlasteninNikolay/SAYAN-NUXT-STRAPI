...
const props = defineProps({
  coordinates: {
    type: Array,
    required: true,
    default: () => [91.412033,53.105589]
  },
  name: {
    type: String,
    default: 'Славянка Саяногорск',
  },
  description: {
    type: String,
    default: 'Краснодарский край, городской округ город-курорт Геленджик, село Криница, территория Красная щель',
  },
})
...
.marker {
  ...
  width: 41px;
  height: 44px;
  background: transparent url('/images/svg/pane.svg') no-repeat;
